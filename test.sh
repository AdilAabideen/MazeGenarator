...
timeout 0.2s ./Maze data/bad_data_missing_s.csv > tmp
...
timeout 0.2s ./Maze data/bad_data_missing_e.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then 
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_perms.csv > tmp
if grep -q "Error: Bad filename" tmp;
then 
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_irregular_width.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then 
    echo "PASS"
else
...
echo -n "Testing Bad Data ( Irregular width ) - "
timeout 0.2s ./Maze data/bad_data_irregular_height.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then 
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_max_width.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_min_width.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_max_height > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then 
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_min_height > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then 
    echo "PASS"
else
...
timeout 0.2s ./Maze data/bad_data_incorrect_characters.csv > tmp
if grep -q "Error: CSV file does not have the expected format" tmp;
then
    echo "PASS"
else
...
echo "" |timeout 0.2s ./Maze data/orignal.csv > tmp
...
echo "j" | timeout 0.2s ./Maze data/orignal.csv > tmp
if grep -q "Error : Invalid Movement character" tmp;
then
    echo "PASS"
else
...
echo "W" | timeout 0.2s ./Maze data/forward_movement.csv > tmp
...
echo "D" | timeout 0.2s ./Maze data/right_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
    echo "PASS"
else
...
echo "S" |timeout 0.2s ./Maze data/down_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
    echo "PASS"
else
...
echo "A" | timeout 0.2s ./Maze data/left_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
    echo "PASS"
else
...
# This tests the forward Movement lowercase w key press by if it is clicked then the user will reach the end point and be treated with a success message
echo -n "Testing W ( forward Movement ) - "
echo "w" | timeout 0.2s ./Maze data/forward_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
...
# This tests the right Movement lowercase d key press by if it is clicked then the user will reach the end point and be treated with a success message
echo -n "Testing D ( Right Movement ) - "
echo "d" | timeout 0.2s ./Maze data/right_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
...
# This tests the downwards Movement lowercase s key press by if it is clicked then the user will reach the end point and be treated with a success message
echo -n "Testing S ( Downward Movement ) - "
echo "s" |timeout 0.2s ./Maze data/down_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
...
# This tests the left Movement Lower Case a key press by if it is clicked then the user will reach the end point and be treated with a success message
echo -n "Testing A ( Left Movement ) - "
echo "a" | timeout 0.2s ./Maze data/left_movement.csv > tmp
if grep -q "Success - You have reached the Exit point" tmp;
then
...
echo "D" | timeout 0.2s ./Maze data/wall_movement.csv > tmp
...
echo "D" | timeout 0.2s ./Maze data/edge_movement.csv > tmp
...
echo "M" | timeout 0.2s ./Maze data/original.csv > tmp
